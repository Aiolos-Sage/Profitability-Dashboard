...
def local_css():
    ...
    <style>
        ...
        /* Metric Card Style - Material Design */
        div.metric-card {
...
if not API_KEY:
    ...
    if json_data:
        ...
        st.markdown(f"## {selected_stock_name} <span style='font-size:18px; color: #5f6368'>({selected_ticker})</span>", unsafe_allow_html=True)
        st.markdown("---")
        ...
        with c4: st.empty() # Placeholder for alignment
